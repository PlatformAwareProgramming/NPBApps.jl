...
const sp_class = Dict([ (CLASS_UNDEFINED, Params(100, 0.010e0, 3.0, 2, 2, 24, 24, 6)),
                        ...
                        (CLASS_C, Params(200, 0.0001e0, 4.5, 1, 1, 480, 320, 28)),
                        (CLASS_D, Params(250, 0.00002e0, 4.5, 1, 1 #=32, 32=#, 1632, 1216, 34)),
                        (CLASS_E, Params(250, 0.000004e0, 4.5, 1, 1, 4096, 2048, 128 #=64, 64, 4224, 3456, 92=#)),
