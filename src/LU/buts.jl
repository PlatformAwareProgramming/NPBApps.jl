...
#---------------------------------------------------------------------
            ...
            tv[5,i] = tv[5,i] - tv[4,i] * tmp

#---------------------------------------------------------------------
#   back substitution
#---------------------------------------------------------------------
            tv[5,i] = tv[5,i]/tmat[5,5]

            tv[4,i] = tv[4,i] - tmat[4,5] * tv[5,i]
            tv[4,i] = tv[4,i]/tmat[4,4]

            tv[3,i] = tv[3,i] - tmat[3,4] * tv[4,i] - tmat[3,5] * tv[5,i]
            tv[3,i] = tv[3,i]/tmat[3,3]

            tv[2,i] = tv[2,i] - tmat[2,3] * tv[3,i] - tmat[2,4] * tv[4,i] - tmat[2,5] * tv[5,i]
            tv[2,i] = tv[2,i]/tmat[2,2]

            tv[1,i] = tv[1,i] - tmat[1,2] * tv[2,i] - tmat[1,3] * tv[3,i] - tmat[1,4] * tv[4,i] - tmat[1,5] * tv[5,i]
            tv[1,i] = tv[1,i]/tmat[1,1]
