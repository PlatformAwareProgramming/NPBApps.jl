...
#---------------------------------------------------------------------
            ...
            ( ( c2 * (  u[2, i, j, k-1] * u[2, i, j, k-1]+
              ...
              ( (  u[2, i, j, k-1]*u[2, i, j, k-1]+
                   u[3, i, j, k-1]*u[3, i, j, k-1]+
                   3.0e+00*u[4, i, j, k-1]*u[4, i, j, k-1] ) * tmp2 ) )-
...
#---------------------------------------------------------------------
               ...
               tmp3 = tmp1 * tmp2
                ...
                b[3, 1, i] = - dt * ty2*
                  ( - ( u[3, i, j-1, k] * tmp1 ) ^ 2+
             0.50e+00 * c2 * ( (  u[2, i, j-1, k] * u[2, i, j-1, k]+
              ...
              dt * ty1 * ( - c34 * tmp2 * u[4, i, j-1, k] )
                ...
                b[5, 3, i] = - dt * ty2*
                 ...
                 ( (  u[2, i, j-1, k]*u[2, i, j-1, k]+
                      3.0e+00 * u[3, i, j-1, k]*u[3, i, j-1, k]+
                      u[4, i, j-1, k]*u[4, i, j-1, k] ) * tmp2 ) )-
                 dt * ty1*
...
#---------------------------------------------------------------------
            ...
            c2 * 0.50e+00 * (  u[2, i-1, j, k] * u[2, i-1, j, k]+
               ...
               c[5, 2, i] = - dt * tx2*
                 ( c1 * ( u[5, i-1, j, k] * tmp1 )-
                    0.50e+00 * c2*
                    ( (  3.0e+00*u[2, i-1, j, k]*u[2, i-1, j, k]+
                         u[3, i-1, j, k]*u[3, i-1, j, k]+
                         u[4, i-1, j, k]*u[4, i-1, j, k] ) * tmp2 ) )-
                  dt * tx1*
