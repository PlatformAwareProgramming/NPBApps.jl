...
function go(class::CLASS; itimer=0, npb_verbose=0, zone_mapping = nothing)
   ...
   @everywhere workers() LU.go_cluster($clusters, $itmax, $inorm, $dt, $ratio, $x_zones, $y_zones, $gx_size, $gy_size, $gz_size, $nxmax, $nx, $ny, $nz, $proc_num_zones, $x_size, $y_size, $zone_proc_id, $proc_zone_id, $iz_west, $iz_east, $iz_south, $iz_north, $itimer, $npb_verbose)       
