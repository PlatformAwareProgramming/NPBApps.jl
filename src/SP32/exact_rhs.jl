          ...
          for k = cell_start[z][3, c]:cell_size[z][3, c]-cell_end[z][3, c]-1
             ...
             for j = cell_start[z][2, c]:cell_size[z][2, c]-cell_end[z][2, c]-1
                ...
                for i = cell_start[z][1, c]:cell_size[z][1, c]-cell_end[z][1, c]-1
                   ...
                   forcing[z][i, j, k, 1, c] = forcing[z][i, j, k, 1, c] -
                       tx2*( ue[z][ip1, 2]-ue[z][im1, 2] )+
                       dx1tx1*(ue[z][ip1, 1]-2.0e0*ue[z][i, 1]+ue[z][im1, 1])

                   forcing[z][i, j, k, 2, c] = forcing[z][i, j, k, 2, c] - tx2 * ((
                   ...
                   forcing[z][i, j, k, 3, c] = forcing[z][i, j, k, 3, c] - tx2 * (
                   ...
                   forcing[z][i, j, k, 4, c] = forcing[z][i, j, k, 4, c] - tx2*(
                   ...
                   forcing[z][i, j, k, 5, c] = forcing[z][i, j, k, 5, c] - tx2*(
...
#---------------------------------------------------------------------
                if cell_start[z][1, c] > 0
                   for m = 1:5
                      i = 1
                      forcing[z][i, j, k, m, c] = forcing[z][i, j, k, m, c] - dssp *(
          ...
          for k = cell_start[z][3, c]:cell_size[z][3, c]-cell_end[z][3, c]-1
             ...
             for i = cell_start[z][1, c]:cell_size[z][1, c]-cell_end[z][1, c]-1
                ...
                for j = cell_start[z][2, c]:cell_size[z][2, c]-cell_end[z][2, c]-1
                   ...
                   forcing[z][i, j, k, 2, c] = forcing[z][i, j, k, 2, c] - ty2*(
                   ...
                   forcing[z][i, j, k, 3, c] = forcing[z][i, j, k, 3, c] - ty2*((
                   ...
                   forcing[z][i, j, k, 4, c] = forcing[z][i, j, k, 4, c] - ty2*(
                   ...
                   forcing[z][i, j, k, 5, c] = forcing[z][i, j, k, 5, c] - ty2*(
          ...
          for j = cell_start[z][2, c]:cell_size[z][2, c]-cell_end[z][2, c]-1
             ...
             for i = cell_start[z][1, c]:cell_size[z][1, c]-cell_end[z][1, c]-1
                ...
                for k = cell_start[z][3, c]:cell_size[z][3, c]-cell_end[z][3, c]-1
                   ...
                   forcing[z][i, j, k, 2, c] = forcing[z][i, j, k, 2, c] - tz2 * (
                   ...
                   forcing[z][i, j, k, 3, c] = forcing[z][i, j, k, 3, c] - tz2 * (
                   ...
                   forcing[z][i, j, k, 4, c] = forcing[z][i, j, k, 4, c] - tz2 * ((
                   ...
                   forcing[z][i, j, k, 5, c] = forcing[z][i, j, k, 5, c] - tz2 * (
...
#---------------------------------------------------------------------
          for m = 1:5
             for k = cell_start[z][3, c]:cell_size[z][3, c]-cell_end[z][3, c]-1
                for j = cell_start[z][2, c]:cell_size[z][2, c]-cell_end[z][2, c]-1
                   for i = cell_start[z][1, c]:cell_size[z][1, c]-cell_end[z][1, c]-1
                      forcing[z][i, j, k, m, c] = -1.0e0 * forcing[z][i, j, k, m, c]
                   end
                end
             end
          end
