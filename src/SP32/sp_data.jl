...
#      grid_size[z] = zeros(Int64, 3)
      ...
      u0 = zeros(Float32, IMAXP[z]+4, JMAXP[z]+4, KMAX[z] + 4, 5, maxcells)
      ...
      ainv0 = zeros(Float32, IMAX[z]+2, JMAX[z]+2, KMAX[z]+2, maxcells)
      ...
      speed0 = zeros(Float32, IMAX[z]+2, JMAX[z]+2, KMAX[z]+2, maxcells)
...
#      global grid_size = Array{Array{Int64}}(undef, proc_num_zones) 
      ...
      global speed = Array{OffsetArray{Float32, 4, Array{Float32, 4}}}(undef, proc_num_zones)
      ...
      global lhs = Array{OffsetArray{Float32, 5, Array{Float32, 5}}}(undef, proc_num_zones)
